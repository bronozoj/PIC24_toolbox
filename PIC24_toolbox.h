 ...
 *  device. The whole codebase is written in C and requires a fair bit
 *  of knowledge concerning programming with PIC microcontrollers using
 *  MPLAB X IDE. This library is fully compatible and made for the 
 *  XC16 compiler and uses libraries from it to function.
 * 

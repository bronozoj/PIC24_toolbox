 ...
 * @return The number of characters written to the lcd.
 * 
 * @note This waits for a minimum of 40us per digit instead of checking if
 * the lcd is ready for a new command due to the lack of an implementation
 * for lcd read back.
 **************************************************************************/

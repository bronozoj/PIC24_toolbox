 ...
 *  
 *  Flag used in the function lcd_display() for the *d* parameter to
 *  signify that the display is to be turned on.
 *
 *  @def DISPLAY_OFF
 * 
 ...
 *  
 *  Flag used in the function lcd_display() for the *d* parameter to
 *  signify that the display is to be turned off.
 */
/**************************************************************************/
 ...
 *  
 *  Flag used in the function lcd_display() for the *c* parameter to
 *  signify that the display is to be shown.
 *
 *  @def CURSOR_OFF
 * 
 ...
 *  
 *  Flag used in the function lcd_display() for the *c* parameter to
 *  signify that the cursor is to be hidden.
 */
/**************************************************************************/
 ...
 *  
 *  Flag used in the function lcd_display() for the *b* parameter to
 *  signify that the character blinking should be enabled.
 *
 *  @def BLINK_OFF
 * 
 ...
 *  
 *  Flag used in the function lcd_display() for the *b* parameter to
 *  signify that the character blinking should be disabled.
 */
/**************************************************************************/
#define BLINK_ON 1
#define BLINK_OFF 0
 ...
 *  
 *  Flag used in the function lcd_cursor() and other functions that
 *  include the cursor placing functionality for the *pos* parameter to
 *  signify that the cursor must be placed at the top row.
 *
 *  @def CURSOR_BOTTOM
 * 
 ...
 *  Flag used in the function lcd_cursor() and other functions that
 *  include the cursor placing functionality for the *pos* parameter to
 *  signify that the cursor must be placed at the bottom row.
 */
/**************************************************************************/
#define CURSOR_TOP 0
